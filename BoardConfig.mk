...
TARGET_PREBUILT_KERNEL := $(TOP)/$(KERNEL_PREBUILTS_DIR)/kernel
BOARD_PREBUILT_DTBIMAGE_DIR := $(TOP)/$(KERNEL_PREBUILTS_DIR)/dtbs
BOARD_PREBUILT_DTBOIMAGE := $(TOP)/$(KERNEL_PREBUILTS_DIR)/dtbo.img
